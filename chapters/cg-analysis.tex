...
\cite{lager_nivre01} present CG as a composition of predicates, numbered by the rules in the grammar. Each predicate is applied to the result of the previous applications, 
and the ``do not remove last reading'' property is checked each time.
