...
The grammar will behave as intended also in a heuristic and sequential variant,
...
and the SAT-solver must handle the original constraint $\neg\laDet \vee \neg\casaV$.
...
Expressing this as a SAT-problem, we get a working CG implementation---that is, parallel CG, known as FSIG. 
...
We see more potential in contributing to the FSIG community, with a practical implementation and ways to get around conflicts.
%Perhaps the biggest contribution in this work has been to 
