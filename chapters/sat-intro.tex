...
SAT-solving as a research area dates back to 19X0s \todo{cite}. Throughout its history, it has been of interest for both theoretical and practical purposes. 
SAT was proven to be NP-complete in 19XX \todo{cite}. This means that we can express any problem in the complexity class NP, such as prime number factorisation, as a SAT-instance, and use a SAT-solver to solve it.
