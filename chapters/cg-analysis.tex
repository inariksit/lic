...
\def\oneClLG{{\sc 1 cl + lemmas}}
\def\twoClLG{{\sc 2 cl + lemmas}}
\def\oneClRG{{\sc 1 cl + readings}}
\def\allRG{{\sc readings}}

\begin{table}[h]
\centering
%\begin{tabular}{|p{3.15cm}|p{2.55cm}|p{2.55cm}|p{2.7cm}|p{2.1cm}|}
%\begin{tabular}{|p{3.05cm}|p{2.55cm}|p{2.55cm}|p{2.7cm}|p{1.8cm}|}
