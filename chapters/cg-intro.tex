...
Similar ideas to CG have been also explored in the finite-state framework, such as Local grammars \cite{gross1997local} and finite-state contextual rules \cite{grana2003fst}, as well as logic programming \cite{oflazer97votingconstraints,lager98} and dependency syntax \cite{tapanainen97fdg}.
...
\textbf{Sequential}
           ...
           & Peltonen2011 \cite{peltonen2011}  &  &\\ %Peltonen2011, p. 80
...
\textbf{Parallel}
           ...
           &                 & \noncg{Voting constraints \cite{oflazer1997votingconstraints}}  \\


  \end{tabular}
  \label{table:nelikentta}
  \caption{Combinations of rule ordering and execution type. \todo{see if Yli-Jyrä says something more about FSIG ordering in his PhD thesis!!!}}
\end{table}
...
CG implementations are shown in xxx font; related systems in cursive font.
...
\todo{\cite{yli-jyra2004fsig_dependency} shows that certain FSIGs are closely related to some mildly context-sensitive grammars.} In \cite{yli-jyra2005phd}, Yli-Jyrä defines the set of \emph{grammatical model strings} 
...
As for another related formalism, \cite{tapanainen1999phd} demonstrates the expressive power of Functional Dependency Grammar \cite{tapanainen97fdg}.
