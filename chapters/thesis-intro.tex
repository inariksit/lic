...
Writing the article was equally divided. The version appearing in this monograph, Chapter~\ref{chapterCGana}, is to large extent the same as the original article, with added detail and examples throughout the chapter.
