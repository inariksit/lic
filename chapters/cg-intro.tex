...
For disambiguation rules based on local constraints, Karlsson mentions \cite{hindle1989disamrules,herz1990localSyntacticConstraints}.
...
Similar ideas to CG have been also explored in the finite-state framework, such as \cite{gross1997local,grana2003fst}. In addition, there are reimplementations of CG using finite-state methods \todo{cite: peltonen 2011; huldén 2011}.
