...
it is true that there are still SAT-problems \todo{formulation? that cannot be solved in sub-exponential time.}
...
One of the biggest success stories for a SAT-application is model checking \cite{sheeran1998modelchecking;biere1999modelchecking;bradley2011modelchecking}, used in software and hardware verification. Furthermore, SAT has been used in domains such as computational biology \cite{claessen2013compbioSAT} and AI planning \todo{cite}---just to pick a few examples.
