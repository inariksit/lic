...
\subsection{Reductionist}\label{reductionist-vs.licencing}
...
This is called a \emph{reductionist} system.
In contrast, a \emph{licencing} system, all constructions must
...
In chapter~\ref{chapterCGana}, we revisit these questions in the context of analysing individual CGs.
...
However, this is often desirable for practical purposes, because it adds robustness.
...
If we know the correct part-of-speech for \emph{what}, then it is easier to disambiguate \emph{question}: there are less possible rules that apply. 
