...
But at the same time, this limits the power of disambiguating conditions.
The most plausible explanation for this phenomenon is the particular features of the tested grammar. When tested with the original 261-rule grammar, 
...
\begin{inparaenum}
\item do we need less rules;
\item do we need careful context;
\item do we write more {\sc select} rules; and
\item will a grammar that performs well with parallel CG also perform well with sequential CG?
\end{inparaenum}
