...
On a related note, \cite{yli-jyra2001} explores the structural correspondence 
between FSIG and constraint-solving problems.


In addition, logic programming has been applied for inducing CG rules.
\cite{lindberg_eineborg98ilp} and \cite{asfrent14} use Inductive Logic Programming to learn CG rules from a tagged corpus, and \cite{lager01transformation} uses a Prolog-based system for transformation-based learning of CG rules. 
