...
One of the biggest success stories for SAT application is model checking \todo{cite}, used in software and hardware verification. In addition, SAT has been used in domains such as computational biology \todo{cite}, AI \todo{cite} and \todo{examples}.
