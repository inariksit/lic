...
Section~\ref{sec:SAT-intro} is a brief and high-level introduction to SAT, aimed to a reader with no prior knowledge on SAT. For a more thorough description, we recommend \todo{x}.
